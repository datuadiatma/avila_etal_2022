...
#riverine = pd.read_csv('riverine10.csv')
#riverine = pd.read_csv('riverine20.csv')
riverine = pd.read_csv('riverine30.csv')
...
par = rss_vec('param_steady.json', 'target.json', tolerance=2e-5,
          mode='riverine',
...
ag1.fill_between(age, Rsw_transient_hi, Rsw_transient_lo, fc='black', alpha=0.15)
...
plt.savefig('../../Figures/MC_Transient_Model_30.png', dpi=300)
plt.savefig('../../Figures/MC_Transient_Model_30.svg')
plt.show()