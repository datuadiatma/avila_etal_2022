...
Scenario 4: Riverine Flux at W=1.3
@author: adiatma.1
"""
...
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario4_riverine30', dpi=300)
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario4_riverine30.svg')
plt.show()