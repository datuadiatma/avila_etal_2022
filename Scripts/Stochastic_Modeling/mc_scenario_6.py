...
Scenario 6: Riverine Flux at W=1.1 Hydrothermal sea-level driven
...
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario6_riverine10_htsealevel', dpi=300)
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario6_riverine10_htsealevel.svg')
plt.show()