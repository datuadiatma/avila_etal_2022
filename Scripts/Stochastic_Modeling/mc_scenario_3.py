...
Scenario 3: Riverine Flux at W=1.2
@author: adiatma.1
"""
...
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario3_riverine20', dpi=300)
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario3_riverine20.svg')
plt.show()