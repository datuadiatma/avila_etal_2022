...
Scenario 7: Riverine Flux at W=1.4 Hydrothermal sea-level driven
...
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario7_riverine40_htsealevel', dpi=300)
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario7_riverine40_htsealevel.svg')
plt.show()