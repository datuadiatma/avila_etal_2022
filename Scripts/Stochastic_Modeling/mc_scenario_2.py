...
# ag1s = fig2.add_subplot(gs[1,0:], sharex=ag1)
ag1s = ag1.twinx()
...
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario2_riverine10', dpi=300)
plt.savefig('../../Figures/MonteCarlo_Simulation/scenario2_riverine10.svg')
plt.show()